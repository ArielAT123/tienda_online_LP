...
<section class="bg-blue-50 py-12">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 class="text-4xl font-bold text-blue-600">{{ $vendor['name'] ?? 'Vendedor' }}</h1>
        <p class="text-neutral-500 mt-2">Vendedor verificado</p>
        <a href="{{ route('products.tags') }}" class="inline-block mt-4 text-sm text-neutral-500 hover:underline">Volver a productos</a>
    </div>
</section>
    ...
    <div class="max-w-3xl mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white border border-neutral-200 p-6 rounded-md shadow-sm">
                    <!-- Avatar & Name -->
                    <div class="flex flex-col items-center gap-4 mb-8 text-center">
                        <div class="w-20 h-20 bg-chocolate flex items-center justify-center flex-shrink-0 rounded-full">
                            <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                            </svg>
                        </div>
                        <div>
                            <h2 class="text-2xl font-bold text-blue-600">{{ $vendor['name'] ?? 'Vendedor' }}</h2>
                    ...
                    <!-- Contact Info -->
                    <div class="space-y-4">
                        <h3 class="text-sm font-bold text-blue-600 uppercase tracking-wider mb-4">Información de Contacto</h3>
                        
                        @if(isset($vendor['email']))
                        <div class="flex items-center gap-4 p-6 bg-neutral-50 border border-neutral-200 rounded-md">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white border border-neutral-200 p-6 rounded-md shadow-sm sticky top-24">
                    <h3 class="text-sm font-bold text-blue-600 uppercase tracking-wider mb-6 text-center">Estadísticas</h3>
        ...
        <div class="mt-8">
            <h2 class="text-lg font-bold text-blue-600 mb-6">Reseñas de Clientes</h2>
            <div class="space-y-4">
        ...
        <div class="mt-8 bg-white border border-neutral-200 p-8 text-center">
            <h2 class="text-lg font-bold text-blue-600 mb-2">Sin reseñas aún</h2>
