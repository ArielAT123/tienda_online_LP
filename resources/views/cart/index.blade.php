                ...
                <div class="bg-white border border-neutral-200">
                    ...
                    <div class="divide-y divide-neutral-100">
                        ...
                        <div class="p-6 flex items-center gap-6 cart-item">
                            <!-- Product Image -->
                            <div class="w-20 h-20 bg-neutral-100 flex-shrink-0 flex items-center justify-center overflow-hidden">
                                @if(!empty($item['img']) || !empty($item['product_img']))
                                    <img src="{{ $item['img'] ?? $item['product_img'] }}" alt="{{ $item['product'] ?? 'Producto' }}" class="w-full h-full object-cover">
                                @else
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-chocolate font-bold text-lg mb-1">
            ...
            <div class="lg:col-span-1">
                <div class="bg-white border border-neutral-200 p-6 sticky top-24 summary">
                    ...
                    <form action="{{ route('cart.checkout') }}" method="POST">
                        @csrf
                        <button type="submit" class="btn-accent w-full py-4 font-bold mb-4">
                            PROCEDER AL PAGO
                        </button>
                    </form>
